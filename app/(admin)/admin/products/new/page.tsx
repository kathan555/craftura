  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-display font-semibold text-charcoal-800">Add New Product</h1>
          <p className="text-stone-400 text-sm mt-0.5">Fill in the details to add to your catalogue</p>
        </div>
      </div>
